...
urlpatterns = patterns('',
    ...
    url(r'^modificarCasosExcepcionales', 'estudiante.views.modificarCasosExcepcionales'),
    ...
    url(r'^retirarIntercambio', 'estudiante.views.retirarIntercambio'),
    ...
    url(r'^verDetalleCasosExc/(?P<id_user>\d+)/$', 'postulante.views.verDetalleCasosExc'),
    ...
    url(r'^recomendarCasoCoord/(?P<id_user>\d+)/$', 'postulante.views.recomendarCasoCoord'),
    url(r'^noRecomendarCoord/(?P<id_user>\d+)/$', 'postulante.views.noRecomendarCoord'),
    url(r'^noRecomendarCasoCoord/(?P<id_user>\d+)/$', 'postulante.views.noRecomendarCasoCoord'),
    ...
    url(r'^ver_tabla_postuladosEXT', 'gestor.views.ver_tabla_postuladosEXT'),
